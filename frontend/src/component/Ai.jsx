...
window.speechSynthesis.speak(utterence)
 ...
 if(transcript.toLowerCase().includes("search") && transcript.toLowerCase().includes("open") && !showSearch){
      ...
      transcript.toLowerCase().includes("who is your owner") ||
      transcript.toLowerCase().includes("who's your creator") ||
      transcript.toLowerCase().includes("who made you") ||
      transcript.toLowerCase().includes("who created you")
    ) {
      speak(" My father and my creator, Chaudhary Deepak Singh Mahalwar.");
    }
    else if (
      transcript.toLowerCase().includes("what is your name") ||
      transcript.toLowerCase().includes("who are you") ||
      transcript.toLowerCase().includes("your name") ||
      transcript.toLowerCase().includes("naam kya hai tumhara ")
    ) {
      speak(" My name is DeepCart AI(kirtimaan),how can I help you?");
    }
    // 🆘 Help command
else if (
  transcript.includes("help") ||
  transcript.includes("i need help") ||
  transcript.includes("haelp")
) {
  speak("Sure! You can say things like open search, go to home page, open cart, or ask who created me.");
}
